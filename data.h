    ...
    while (fgets(line, 128, fp) != NULL)
    {
		...
		*(word + k) = '\0';
		...
		if (strstr(word, "processcount") != NULL)
		{
			...
			num =(char*) malloc(sizeof(char) * ((wordLen) - 12 + 1));
			...
			*(num + (i - 12)) = '\0';
			...
			data->pcbArray = (PCB**) malloc(sizeof(PCB*) * data->processcount);
		...
		{
			num = (char*)malloc(sizeof(char) * ((wordLen) - 6 + 1));
		...
		else if(strstr(word, "use") != NULL)
		{
			...
			data->algorithm = (char*)malloc(sizeof(char) * (wordLen - 3 + 1));
		...
		else if (strstr(word, "quantum") != NULL)
		{
			...
			num =(char*) malloc(sizeof(char) * ((wordLen) - 7));
		...
		else if (strstr(word, "processname") != NULL)
		{
			...
			data->pcbArray[j]->name = (char*) malloc(sizeof(char) * (nameLen + 1));
			...
			num =(char*) malloc(sizeof(char) * (arrivalLen + 1));
			...
			*(num + i) = '\0';
			...
			num =(char*) malloc(sizeof(char) * (burstLen + 1));
